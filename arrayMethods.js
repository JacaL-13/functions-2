...
// CODE HERE
const postTaxPrices = prices.map(num => Math.round((num * 1.07 + Number.EPSILON) * 100) / 100)
...
// CODE HERE
const billTotals = orders.map(bill => bill.price + bill.tax)
...
// CODE HERE
const bobsTotal = purchases/*.filter(element => element.owner.toLowerCase() === 'bob')*/.reduce((prev, curr) => prev.price + curr.price)
